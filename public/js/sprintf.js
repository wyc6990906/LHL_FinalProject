function sprintf() {
  var e = /%%|%(\d+\$)?([\-+\'#0 ]*)(\*\d+\$|\*|\d+)?(?:\.(\*\d+\$|\*|\d+))?([scboxXuideEfFgG])/g,
      ...
      return (
        s > 0 &&
          (e =
            t || !i
              ? a(e, n, c, t)
              : e.slice(0, r.length) + a("", s, "0", !0) + e.slice(r.length)),
        e
      );
    },
    c = function (e, r, t, n, c, s, o) {
      var u = e >>> 0;
      return (
        (t = (t && u && { 2: "0b", 8: "0", 16: "0x" }[r]) || ""),
        (e = t + a(u.toString(r), s || 0, "0", !1)),
        i(e, t, n, c, o)
      );
    },
    s = function (e, r, t, n, a, c) {
      return (
        null !== n && void 0 !== n && (e = e.slice(0, n)), i(e, "", r, t, a, c)
      );
    },
